...
export const MONSTERS: MonsterDef[] = [
  ...
  },
  {
    ...
    strength: 2,
    baseDamage: 1,
    rulesText: "Vid träff: tappa ett slumpmässigt utrustat föremål.",
    rewardGold: 3,
    rewardItems: 0,
  ...
  },
  {
    ...
    strength: 5,
    baseDamage: 6,
    rulesText: "Vid träff: alla intilliggande spelare tar 1 skada.",
    lossSipsOnLose: 1,
    rewardGold: 7,
    rewardItems: 2,
  ...
  },
  {
    ...
    baseDamage: 5,
    rulesText:
      "Vid träff: du får ta en klunk för att minska skadan med 3 — eller ta full skada utan att dricka.",
    rewardGold: 5,
    rewardItems: 1,
