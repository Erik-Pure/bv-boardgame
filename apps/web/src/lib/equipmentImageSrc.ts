...
export function equipmentUniqueImageSrc(name?: string): string | null {
  ...
  const map: Record<string, string> = {
    ...
    Plastmugg: "/equipment/weapon/plasticcup.webp",
    ...
    Hawaiiskjorta: "/equipment/armor/hawaiishirt.webp",
    "Hawaiian Shirt": "/equipment/armor/hawaiishirt.webp",
    ...
    Pannband: "/equipment/helmet/headband.webp",
    ...
    Anteckningsblock: "/equipment/accessory/notebook.webp",
