...
export const sv = {
  ...
  play: {
    ...
    waitTeammateCombatRoll: (name: string) => `${name} ska fortfarande slå sin stridstärning.`,
    ...
    combatCardSheetTitle: "Strid",
    combatWinTitle: "VINST!",
