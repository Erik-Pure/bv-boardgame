...
export const sv = {
  ...
  statsDashboard: {
    title: "Statistik",
    lead: "Historik över starter och spelare per period. Live-siffror visas sekundärt. Kräver admin-token.",
    homeLink: "← Startsida",
    tokenAria: "Admin-token",
    tokenLabel: "Admin-token",
    tokenPlaceholder: "ADMIN_TOKEN",
    tokenSave: "Spara",
    tokenHint: "Token lagras i sessionStorage för den här fliken. Sidan är olänkad — samma mönster som festöversikten.",
    rangeAria: "Tidsperiod",
    range7d: "7 dagar",
    range30d: "30 dagar",
    rangeWeek: "Denna vecka",
    rangeMonth: "Denna månad",
    rangeMeta: "Period",
    refresh: "Uppdatera",
    refreshing: "Uppdaterar…",
    clearToken: "Rensa token",
    errorUnauthorized: "Ogiltig eller saknad admin-token.",
    errorLoad: "Kunde inte läsa statistik.",
    errorReachServer: "Kunde inte nå servern.",
    liveAria: "Just nu",
    liveTitle: "Just nu",
    liveRooms: "Rum",
    livePlaying: "Spelande",
    livePlayers: "Spelare i match",
    historyAria: "Historik",
    historyTitle: "Historik",
    gamesStarted: "Starter",
    gamesEnded: "Avslutade",
    gamesAbandoned: "Övergivna",
    playerParticipations: "Spelardeltaganden",
    uniquePlayerNames: "Unika namn",
    uniquePlayerNamesNote: "Uppskattning via normaliserade visningsnamn — inte konton.",
