...
export const sv = {
  ...
  statsDashboard: {
    title: "Statistik",
    lead: "Historik över starter och spelare per period. Live-siffror visas sekundärt. Sidan är lösenordsskyddad.",
    homeLink: "← Startsida",
    tokenAria: "Lösenord",
    tokenLabel: "Lösenord",
    tokenPlaceholder: "Lösenord",
    tokenSave: "Lås upp",
    tokenHint: "Ange lösenordet för statistiksidan. Det sparas bara i den här fliken tills du rensar det eller stänger fliken.",
    ...
    clearToken: "Lås",
    errorUnauthorized: "Fel lösenord.",
