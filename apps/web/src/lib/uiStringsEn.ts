...
export const en = {
  ...
  play: {
    ...
    itemSuffixWeakBeer: " (−2 player attack)",
    itemSuffixLightBeer: " (+1 player attack)",
    itemSuffixFolkBeer: " (+2 player attack)",
    itemSuffixTripwire: " (−1 player attack)",
    itemSuffixDoubleHops: " (+2 player attack)",
    itemSuffixBeerBomb: " (+3 player attack)",
    itemSuffixManopositiv: " (+4 player attack, −10 cans)",
    itemSuffixHangover: " (−3 player attack)",
    itemSuffixLengraddad: " (−2 player attack)",
