...
export const en = {
  ...
  statsDashboard: {
    title: "Statistics",
    lead: "History of starts and players per period. Live counts are secondary. Requires an admin token.",
    homeLink: "← Home",
    tokenAria: "Admin token",
    tokenLabel: "Admin token",
    tokenPlaceholder: "ADMIN_TOKEN",
    tokenSave: "Save",
    tokenHint: "Token is stored in sessionStorage for this tab. The page is unlinked — same pattern as the party overview.",
    ...
    errorUnauthorized: "Invalid or missing admin token.",
